...
const Categories = () => {
  ...
  const saveCategory = async (e) => {
    ...
    if(editingCategory){
      const response = await axios.put("/api/categories",{name, parentCategory, _id:editingCategory._id})
    ...
    <div className='w-full h-full text-blue-900 px-4'>
        ...
        <thead className="bg-blue-100 p-2">
          <tr className="border">
            ...
            <td className="border p-1">Parent Category Name</td>
        ...
        <tbody className="border p-1">
          {
            categories.map((category, index) => (
              <tr className="border p-1" key={category._id}>
