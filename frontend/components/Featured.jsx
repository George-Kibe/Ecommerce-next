  ...
  return (
    <section className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-6 px-4 py-8 md:grid-cols-2 md:gap-10 md:px-8 md:py-12">
      ...
      <div className="order-2 md:order-1">
        <h1 className="mb-2 text-2xl font-semibold text-gray-900 md:mb-4 md:text-4xl">
          {product.title}
        </h1>
        <p className="text-gray-700 md:text-lg">{product.description}</p>

        <div className="mt-4 flex flex-wrap gap-3 md:mt-6">
          <Link
            href={`/products/${product._id}`}
            className="inline-flex min-h-11 items-center justify-center rounded-lg border border-blue-700 px-5 text-sm font-medium text-blue-700 hover:bg-blue-700 hover:text-white focus:ring-4 focus:ring-blue-300 focus:outline-none"
          >
            Read more
          </Link>
          <button
            ...
            className="inline-flex min-h-11 items-center justify-center rounded-lg bg-blue-700 px-5 text-sm font-medium text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 focus:outline-none"
          >
