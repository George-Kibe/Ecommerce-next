...
const Footer = () => {
  return (    
    <footer className="mt-4  md:mt-8 bottom-0 left-0 z-20 w-full p-4 text-white bg-black border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600">
