  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        title="Colour theme"
        className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-full text-chrome-fg transition-colors hover:bg-white/10 hover:text-chrome-fg-strong"
      >
